...
const settingsPopup = document.getElementById("settings-popup") // tetap sama
...
const popupHideInput = document.getElementById("popup-hide-sec")
const saveBtn = document.getElementById("save-settings")
const closeBtn = document.getElementById("close-settings")

// event double click brand
document.querySelector(".brand").addEventListener("dblclick", (e) => {
  e.preventDefault() // cegah zoom
...
saveBtn.addEventListener("click", () => {
  ...
  const settings = {
    ...
    iqomahDelaySec: Number(iqomahDelayInput.value) || 30,
    popupHideSec: Number(popupHideInput.value) || 15,
  }
...
closeBtn.addEventListener("click", () => {
  settingsPopup.classList.add("hidden") // keluar tanpa simpan
})
...
function onAdzanStart() {
  ...
  Object.assign(popupText.style, {
    backgroundColor: "rgba(0, 16, 28, 0.37)", // rgb(0 0 0 / 29%) → rgba
    borderRadius: "2vw", // atau "32px" sesuai preferensi
    height: "20vh",
    fontSize: "2.5vw", // atau "3rem" kalau mau lebih besar
    fontWeight: "700",
    marginBottom: "5%",
    animation: "slideUp 0.8s ease both", // urutan: namaDurasiTimingFunctionFillMode
    letterSpacing: "4px",
    display: "flex",
    alignItems: "center",
